...
docker run -it --rm --device /dev/dri/renderD128 --group-add="$(stat -c "%g" /dev/dri/renderD128)" openvino/ubuntu22_dev:2024.4.0 samples/cpp/samples_bin/samples_bin/hello_query_device
